...
def legendre_poly_plot(data_file_path: Path, output_path: Path):
    # load the data
    data = np.loadtxt(data_file_path.absolute())
    ...
    output_file_path = output_path / "legendre_polynomials.png"
    plt.savefig(output_file_path.absolute())
    ...
    output_file_path = output_path / "legendre_derivatives_polynomials.png"
    plt.savefig(output_file_path.absolute())
